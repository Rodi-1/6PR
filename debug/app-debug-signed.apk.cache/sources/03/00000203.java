...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        public boolean isGroupConversation() {
            if (this.mBuilder == null || this.mBuilder.mContext.getApplicationInfo().targetSdkVersion >= 10000) {
        ...
        public void addCompatExtras(Bundle extras) {
            ...
            extras.putBoolean(NotificationCompat.EXTRA_IS_GROUP_CONVERSATION, this.mIsGroupConversation);
        }
        ...
        protected void restoreFromCompatExtras(Bundle extras) {
            ...
            this.mIsGroupConversation = extras.getBoolean(NotificationCompat.EXTRA_IS_GROUP_CONVERSATION);
        }
