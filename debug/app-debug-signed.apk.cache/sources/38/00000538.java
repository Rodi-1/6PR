...
public class GridLayout extends ViewGroup {
    ...
    static {
        Alignment alignment = new Alignment() { // from class: android.support.v7.widget.GridLayout.3
            @Override // android.support.v7.widget.GridLayout.Alignment
            int getGravityOffset(View view, int cellDelta) {
                return 0;
            }
        ...
        LEADING = alignment;
        Alignment alignment2 = new Alignment() { // from class: android.support.v7.widget.GridLayout.4
            @Override // android.support.v7.widget.GridLayout.Alignment
            int getGravityOffset(View view, int cellDelta) {
                return cellDelta;
            }
    ...
    private int getDefaultMargin(View c, LayoutParams p, boolean horizontal, boolean leading) {
        ...
        if (this.mUseDefaultMargins) {
            ...
            boolean leading1 = (horizontal && isLayoutRtlCompat()) ? !leading ? DEFAULT_ORDER_PRESERVED : false : leading;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        while (cx < N) {
            ...
            if (c.getVisibility() == 8) {
                ...
                i = cx;
                int alignmentOffsetX = boundsX.getOffset(this, c, hAlign, i2, DEFAULT_ORDER_PRESERVED);
    ...
    public final class Axis {
        ...
        private Arc[] topologicalSort(Arc[] arcs) {
            return new Object(arcs) { // from class: android.support.v7.widget.GridLayout.Axis.1
                static final /* synthetic */ boolean $assertionsDisabled = false;
                Arc[][] arcsByVertex;
                int cursor;
                Arc[] result;
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void init(Context context, AttributeSet attrs) {
            ...
            try {
                ...
                int i = COLUMN_SPAN;
                int i2 = DEFAULT_SPAN_SIZE;
                int colSpan = a.getInt(i, i2);
                ...
                int rowSpan = a.getInt(ROW_SPAN, i2);
