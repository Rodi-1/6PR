...
public class b {
    ...
    public static class C0016b {
        ...
        C0016b(char c2, float[] fArr) {
            this.f1525a = c2;
            this.f1526b = fArr;
        }

        C0016b(C0016b c0016b) {
            this.f1525a = c0016b.f1525a;
            float[] fArr = c0016b.f1526b;
            this.f1526b = b.c(fArr, 0, fArr.length);
        }
        ...
        public static void e(C0016b[] c0016bArr, Path path) {
            float[] fArr = new float[6];
            char c2 = 'm';
            for (int i2 = 0; i2 < c0016bArr.length; i2++) {
                a(path, fArr, c2, c0016bArr[i2].f1525a, c0016bArr[i2].f1526b);
                c2 = c0016bArr[i2].f1525a;
            }
        }

        public void d(C0016b c0016b, C0016b c0016b2, float f2) {
            int i2 = 0;
            while (true) {
                float[] fArr = c0016b.f1526b;
                if (i2 >= fArr.length) {
                ...
                this.f1526b[i2] = (fArr[i2] * (1.0f - f2)) + (c0016b2.f1526b[i2] * f2);
                i2++;
            }
        }
    }

    private static void a(ArrayList<C0016b> arrayList, char c2, float[] fArr) {
        arrayList.add(new C0016b(c2, fArr));
    }

    public static boolean b(C0016b[] c0016bArr, C0016b[] c0016bArr2) {
        if (c0016bArr == null || c0016bArr2 == null || c0016bArr.length != c0016bArr2.length) {
            return false;
        }
        for (int i2 = 0; i2 < c0016bArr.length; i2++) {
            if (c0016bArr[i2].f1525a != c0016bArr2[i2].f1525a || c0016bArr[i2].f1526b.length != c0016bArr2[i2].f1526b.length) {
                return false;
            }
        }
        return true;
    ...
    public static C0016b[] d(String str) {
        if (str == null) {
            return null;
        }
        ...
        return (C0016b[]) arrayList.toArray(new C0016b[arrayList.size()]);
    }
    ...
    public static C0016b[] f(C0016b[] c0016bArr) {
        if (c0016bArr == null) {
            return null;
        }
        C0016b[] c0016bArr2 = new C0016b[c0016bArr.length];
        for (int i2 = 0; i2 < c0016bArr.length; i2++) {
            c0016bArr2[i2] = new C0016b(c0016bArr[i2]);
        }
        return c0016bArr2;
    }
    ...
    */
    private static void g(java.lang.String r8, int r9, i.b.a r10) {
        /*
            r0 = 0
            r10.f1524b = r0
            r1 = r9
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: i.b.g(java.lang.String, int, i.b$a):void");
    }
    ...
    public static void j(C0016b[] c0016bArr, C0016b[] c0016bArr2) {
        for (int i2 = 0; i2 < c0016bArr2.length; i2++) {
            c0016bArr[i2].f1525a = c0016bArr2[i2].f1525a;
            for (int i3 = 0; i3 < c0016bArr2[i2].f1526b.length; i3++) {
                c0016bArr[i2].f1526b[i3] = c0016bArr2[i2].f1526b[i3];
            }
        }
    }
}