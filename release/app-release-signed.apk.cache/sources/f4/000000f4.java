...
public class AlertDialogLayout extends C0272i0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: A */
    private boolean m1496A(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0574f.topPanel) {
                    view = childAt;
                } else if (id == C0574f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0574f.contentPanel && id != C0574f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    /* renamed from: j */
    private void m1495j(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0272i0.C0273a c0273a = (C0272i0.C0273a) childAt.getLayoutParams();
                if (((ViewGroup.MarginLayoutParams) c0273a).width == -1) {
                    int i4 = ((ViewGroup.MarginLayoutParams) c0273a).height;
                    ((ViewGroup.MarginLayoutParams) c0273a).height = childAt.getMeasuredHeight();
    ...
    /* renamed from: y */
    private void m1494y(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: z */
    private static int m1493z(View view) {
        int m407e = C0490o.m407e(view);
        if (m407e > 0) {
            return m407e;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1493z(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            android.support.v7.widget.i0$a r15 = (android.support.p002v7.widget.C0272i0.C0273a) r15
            int r2 = r15.f1343b
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = p016o.C0490o.m408d(r17)
            int r2 = p016o.C0474d.m456a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L95
            r3 = 5
